...
:param EMBED_NAME: Name of server message embeding.
:param EMBED_COLOR: Color of server message embeding.
:param EMBED_URL: URL of server message embeding.
:param EMBED_ICON_URL: Icon URL of server message embeding.
...
:type EMBED_NAME: String
:type EMBED_COLOR: Hexadecimal
:type EMBED_URL: String
:type EMBED_ICON_URL: String
